...
//        $logger->conf["log_file"] = rtrim(TOP_SDK_WORK_DIR, '\\/') . '/' . "logs/top_comm_err_" . $this->appkey . "_" . date("Y-m-d") . ".log";
        $logger->conf["log_file"] = "/data/wwwlogs/qimen-logs/top_biz_err_" . $this->appkey . "_" . date("Y-m-d") . ".log";
    ...
    {
        if( $this->gatewayUrl == null ) throw new Exception("client-check-error:Need Set gatewayUrl.", 40);
...
//        $specialCharacters = ["'" ,"&", "#", "%", "+", "\\"];
        ...
        $this->body = str_replace( $specialCharacters, "",  convertMes( $apiParams,  true, $xmlType ) );
...
//            $logger->conf["log_file"] = rtrim(TOP_SDK_WORK_DIR, '\\/') . '/' . "logs/top_biz_err_" . $this->appkey . "_" . date("Y-m-d") . ".log";
    ...
    public function exec($paramsArray)
    {
        ...
        return $this->execute($req, null, $session);
    }
